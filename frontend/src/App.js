...
// const Add_client = React.lazy(()=> import('./components/Dashboard'));
// const My_tree_view = React.lazy(()=> import('./components/Dashboard'));
// const Update_kyc = React.lazy(()=> import('./components/Dashboard'));
// const Update_bank_details = React.lazy(()=> import('./components/Dashboard'));
// const Order_history = React.lazy(()=> import('./components/Dashboard'));
// const Profile = React.lazy(()=> import('./components/Dashboard'));
// const LazyDashboard = React.lazy(()=> import('./components/Dashboard'));
// const LazyDashboard = React.lazy(()=> import('./components/Dashboard'));
// const LazyDashboard = React.lazy(()=> import('./components/Dashboard'));
// const LazyDashboard = React.lazy(()=> import('./components/Dashboard'));

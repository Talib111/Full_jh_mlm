...
function Bank_account_details_form2(props) {

  //toast
  const notify = ()=>{
    toast.success('Bank details updated successfully!',{autoClose: false});
    ...
    const validationSchema = Yup.object({
      ...
      const send_to_backend=(values)=>{
        ...
        //get id to push
        xhttp.send(JSON.stringify({_id: props.current_User_Id,bank_Details: values}));
...
// export default Bank_account_details_form2
export default connect(mapStateToProps,mapDispatchToProps)(Bank_account_details_form2)
